...
class network(cmodel):
    ...
    def __init__(self, config):
        ...
        self.visual_names = ['INPUT_X',"FLOW_LABEL_SHOW",'FLOW_PREDICT_SHOW']
        self.model_names = ["G"]

        self.netG = backbone.create_backbone(net_name='FlowNetS_SF',
    ...
    def forward(self):
        self.FLOW_PREDICT = self.netG.forward(self.INPUT_X)
